...
template<typename T,typename Y>  TMatrix4x4<T> operator *( Y s, const TMatrix4x4<T> &m );
template<typename T,typename Y>  TMatrix4x4<T> operator *( const TMatrix4x4<T> &m, Y s  );
template<typename T,typename Y>  TMatrix3x3<T> operator *( Y s, const TMatrix3x3<T> &m );
template<typename T,typename Y>  TMatrix3x3<T> operator *( const TMatrix3x3<T> &m, Y s  );
