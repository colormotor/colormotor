 ...
 *  EpsFile.cpp
 *
 *  Created by Daniel Berio on 11/23/11.
 *  http://www.enist.org
...
namespace cm
{
	...
	// stroke(); or fill();
	// showpage();		
	void	EpsFile::shape( const Shape2d & s )
	{
		if(!_file)
			return;
		...
		for( int i = 0; i < s.getNumContours(); i++ )
		{
			const Path2d & pa = s.getContour(i);
			for( int j = 0; j < pa.size(); j++ )
			{
				const Vec2 & p = pa.getPoint(j);
				if( j == 0 )
					moveto(p.x,p.y);
				else
					lineto(p.x,p.y);
			}
			if(pa.isClosed() || fillType!= NONE)
				closepath();
		}
	...
	void	EpsFile::shape( const Path2d & pa )
	{
		if(!_file)
			return;
	...
	void 	EpsFile::header( const Rect & rect )
	{
	...
	/////////////////////////////////////////////////////
	void		EpsFile::setrgb( const Color & clr )
	{
		if(!_file)
			return;
	...
	/////////////////////////////////////////////////////
	void EpsFile::circle( const Vec2 & pos, float radius )
	{
		//gsave();
	...
	/////////////////////////////////////////////////////
	void EpsFile::text( const Vec2 & pos, float size, const std::string & str )
	{
		gsave();
		newpath();
	...
	/////////////////////////////////////////////////////
	void		EpsFile::setrgb(unsigned int clr)
	{
		setrgb( (float)GET_R(clr) * DIV255, (float)GET_G(clr) * DIV255, (float)GET_B(clr) * DIV255 );
	}
	...
	/////////////////////////////////////////////////////
	void		EpsFile::moveto( const Vec2 & v )
	{
		moveto(v.x,v.y);
	}
	...
	/////////////////////////////////////////////////////
	void		EpsFile::lineto( const Vec2 & v )
	{
		lineto(v.x,v.y);
	}
	/////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////
	void		EpsFile::arrowto( const Vec2 & v )
	{
		arrowto(v.x,v.y);
	}
	/////////////////////////////////////////////////////
	...
	void		EpsFile::rlineto( const Vec2 & v )
	{
		rlineto(v.x,v.y);
	}
	...
	void EpsFile::strokeRgb( const Color & clr )
	{
		strokeRgb(clr.r, clr.g, clr.b);
	}
	...
	void EpsFile::fillRgb( const Color & clr )
	{
		fillRgb(clr.r, clr.g, clr.b);
	}
	...
	void EpsFile::strokeShape( const Shape2d & s, const Color & clr )
	{
		gsave();
		fillNone();
		strokeRgb(clr);
	...
	void EpsFile::fillShape( const Shape2d & s, const Color & clr )
	{
		gsave();
		strokeNone();
		fillRgb(clr);
	...
	void EpsFile::strokeShape( const Shape & s, const Color & clr )
	{
		gsave();
		fillNone();
		strokeRgb(clr);
	...
	void EpsFile::fillShape( const Shape & s, const Color & clr )
	{
		gsave();
		strokeNone();
		fillRgb(clr);
	...
	void EpsFile::strokeCircle( const Vec2 & center, float radius, const Color & clr )
	{
		gsave();
		fillNone();
		strokeRgb(clr);
	...
	void EpsFile::fillCircle( const Vec2 & center, float radius, const Color & clr )
	{
		gsave();
		strokeNone();
		fillRgb(clr);
	...
	void EpsFile::strokeRect( float x, float y, float w, float h, const Color & clr )
	{
		gsave();
		fillNone();
		strokeRgb(clr);
	...
	void EpsFile::fillRect( float x, float y, float w, float h, const Color & clr )
	{
		gsave();
		strokeNone();
		fillRgb(clr);
	...
	void EpsFile::drawLine( const Vec2 & a, const Vec2 & b, const Color & clr )
	{
		gsave();
		newpath();
		fillNone();
	...
	void EpsFile::drawArrow( const Vec2 & a, const Vec2 & b, float size, const Color & clr )
	{
		gsave();
		fillRgb(clr);
		strokeRgb(clr);
